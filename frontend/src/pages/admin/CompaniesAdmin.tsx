        ...
        <div className="bg-surface-container-lowest rounded-[12px] border border-outline-variant/40 overflow-hidden card-rest">
          <div className="p-12 flex flex-col items-center justify-center text-center space-y-6">
            ...
            <div className="w-full max-w-xl mt-4">
              <div className="text-left text-[10px] uppercase tracking-widest font-bold text-on-surface-variant px-4 py-2">
              ...
              <div className="space-y-[1px] bg-on-surface/5 rounded-xl overflow-hidden border border-on-surface/5">
                {[
                  ...
                  >
                    ...
                    <span className="inline-block px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-on-surface/5 text-on-surface-variant">
                      {company.type}
                    </span>
                  </div>
                ))}
              </div>
              <p className="text-[10px] text-on-surface-variant text-center mt-3 font-label">
